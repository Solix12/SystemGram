package com.salikh.systemgram.activities;
...
import com.salikh.systemgram.R;
import com.salikh.systemgram.adapters.ChatAdapter;
import com.salikh.systemgram.databinding.ActivityChatBinding;
import com.salikh.systemgram.mdels.ChatMessage;
import com.salikh.systemgram.mdels.User;
import com.salikh.systemgram.network.ApiClient;
import com.salikh.systemgram.network.ApiService;
import com.salikh.systemgram.utilities.Constants;
import com.salikh.systemgram.utilities.PreferenceManager;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        if (conversionId != null) {
            ...
            conversions.put(Constants.KEY_RECEIVER_ID, receiverUser.id);
            conversions.put(Constants.KEY_RECEIVE_NAME, receiverUser.name);
            conversions.put(Constants.KEY_RECEIVE_IMAGE, receiverUser.image);
    ...
    private void listenAvailabilityOfReceiver() {
        database.collection(Constants.KEY_COLLECTIONS_USERS).document(
            ...
            if (isReceiverAvailable) {
                binding.textAvailable.setText("Online");
                binding.textAvailable.setTextColor(getResources().getColor(R.color.available));
            } else {
                binding.textAvailable.setText("Offline");
                binding.textAvailable.setTextColor(getResources().getColor(R.color.black));
            }
